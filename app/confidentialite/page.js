        ...
        <div className="bg-white rounded-2xl shadow p-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              et supprimées dans les 30 jours suivant la résiliation de votre compte.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Pour exercer ces droits contactez-nous à : <strong>contact@zimvu.fr</strong>
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Pour toute question relative à vos données : <strong>contact@zimvu.fr</strong>
            </p>
          </div>
        </div>
