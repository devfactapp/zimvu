        ...
        <div style={{position:'fixed', inset:0, backgroundColor:'rgba(0,0,0,0.5)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:50, padding:'0 16px'}}>
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
            ...
            <p className="text-gray-500 text-sm mb-6">
              La note de <strong>{confirmSupprimer.montant} €</strong> ({confirmSupprimer.categorie}) sera supprimée définitivement.
            </p>
        ...
        {statsCat.length > 0 && (
          <div className="mb-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
              {statsCat.map(cat => (
                <div key={cat.label} className="bg-white rounded-2xl shadow p-4">
                  ...
                  <p className="text-lg font-bold text-blue-700">{cat.total.toFixed(2)} €</p>
                </div>
              ))}
            </div>
            <div className="bg-blue-600 rounded-2xl p-4 text-white flex justify-between items-center">
              ...
              <span className="text-2xl font-bold">{totalGeneral.toFixed(2)} €</span>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-2xl shadow p-4 md:p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  placeholder="Ex: Billet de train Paris-Lyon"
                  ...
                  <tbody>
                    {frais.map((f) => (
                      <tr key={f.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 font-semibold text-blue-700">{f.montant} €</td>
